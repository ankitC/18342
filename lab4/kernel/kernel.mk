...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o timer.o SWI_dispatcher.o C_SWI_handler.o hijack.o prepare_irq_stack.o init.o irq_handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
